...
| `/businesses/:businessId/sub-scores` | `SubScoresPage` | `DashboardShell`, subscore cards, radar SVG, bar chart, inventory insight charts | Yes | `admin`, `user` | User: `GET /businesses/:id`, `GET /businesses/:id/inventory-submissions/latest`; Admin: `GET /admin/businesses/:id`, `GET /admin/businesses/:id/inventory-submissions/latest` | Detail enam sub-skor bisnis, insight operasional dari data inventarisasi, dan legend interpretasi skor. |
